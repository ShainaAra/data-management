  ...
  const [projects, setProjects] = useState([
    {
      id: 1,
      name: "Data Sync",
      desc: "Automated data export to external servers",
      createdBy: "Nash",
      date: "2025-10-20",
    },
    {
      ...
      desc: "Generate and export AI reports to PDF",
      createdBy: "Ara",
      date: "2025-10-18",
    },
    {
      id: 3,
      name: "Secure Backup",
      desc: "Encrypt and export system backups",
      createdBy: "Jamie",
      date: "2025-10-10",
    },
  ]);
        ...
        <table className="min-w-full border-collapse">
          <thead className="bg-gray-50 text-gray-700">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-semibold">Export Name</th>
      ...
      {isEditModalOpen && projectToEdit && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-lg font-semibold mb-4">Edit Export</h2>
