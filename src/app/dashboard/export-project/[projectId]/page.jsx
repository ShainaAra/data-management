...
import ExportProjectSummary from "../ExportProjectSummary";
...
export default function ExportDetails() {
  ...
  useEffect(() => {
    ...
    if (!found) {
      router.replace("/dashboard/export-project");
      return;
    }
    setProject(found);
  }, [projectId]);
  ...
  <div className="bg-white border border-blue-500 rounded-2xl shadow-md p-8 md:p-10 max-w-7xl mx-auto">
        ...
        >
          <ArrowLeft className="h-4 w-4" /> Back to Export Projects
        </Link>
          ...
          <CardContent className="p-0">
            ...
            {!isEditMode ? (
              <>
                ...
                <ExportProjectSummary files={dummyFiles} setFiles={setDummyFiles} />
